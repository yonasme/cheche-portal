...
const ItemList = () => {
  ...
  const pageCount = Math.ceil(data?.admins?.length / usersPerPage);
  ...
  useEffect(() => {
    http
      .get(`${baseUrl}/api/user/listAdmins`)
      .then((res) => {
        setData(res.data);
      })
      .catch((err) => {
          ...
          <tr key={items._id}>
            ...
            <td>
              <div className="flex align-items-center list-user-action">
                ...
                >
                  <span title="Add Admin" className="btn-inner">
                    <svg
                      width="32"
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                >
                  <span title="Edit Admin" className="btn-inner">
                    <svg
                      width="20"
                      viewBox="0 0 24 24"
                      fill="none"
            ...
            <Row>
              <Col xl="12" lg="8">
                <Card>
                  <Card.Header className="d-flex justify-content-between">
                    <div className="header-title">
                      <h4 className="card-title">Update Admin Information</h4>
                    </div>
                  </Card.Header>
                  <Card.Body>
                    <div className="">
