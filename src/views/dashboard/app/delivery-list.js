...
const DeliveryList = () => {
  ...
  const onSubmit = async () => {
    http
      .post(`${baseUrl}/api/deliveryTime/update`, {
  ...
  const onDelete = async () => {
    http
      .post(`${baseUrl}/api/deliveryTime/delete`, 
      {
        code: code,
      }
      )
      .then((res) => {
        ...
        history.push('/dashboard/deliveryList', { replace: true });
      })
      .catch((err) => {
  ...
  useEffect(() => {
    http
      .get(`${baseUrl}/api/deliveryTime/getAll`)
      .then((res) => {
        setData(res.data);
      })
      .catch((err) => {
  ...
  const DisplayData = data?.deliveryTimes
          ...
          <tr key={code}>
            ...
            <td>
              <div className="flex align-items-center list-user-action">
                ...
                >
                  <span title="Add Delivery Type" className="btn-inner  ">
                ...
                >
                  <span title="Edit Type" className="btn-inner">
                    <svg
                      width="18"
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                >
                  <span title="Delete Delivery Type" className="btn-inner  flex-item fluid">
                  <svg fill="white" class="svg-icon" viewBox="0 0 20 20">
                ...
                <div className=" py-3 pl-2">
                  <div className="relative max-w-xs">
                    ...
                    <input
                      ...
                      placeholder="Search Delivery Type by Name"
                    />
                  </div>
                </div>
                <div className="header-title">
                  <h4 className="card-title">Delivery Type List</h4>
                </div>
              </Card.Header>
